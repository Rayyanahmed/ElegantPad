...
;
(function() { this.JST || (this.JST = {}); this.JST["notebooks/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="modal_container">\n\t<div class="modal" style="top: ',  dim.top ,'px; left: ',  dim.left ,'px;">\n\n\t\t<div class="trash_logo">\n\t\t\t<img src="assets/create_notebook.png" alt="">\n\t\t</div>\n\n\t\t<div class="modal_header">\n\t\tCREATE NOTEBOOK\n\t\t</div>\n\n\t\t<input type="text" class="notebook_title" name="title" placeholder="Title your notebook">\n\n\t\t<div class="modal_buttons">\n\t\t\t<button class="cancel">Cancel</button>\n\t\t\t<button class="confirm">Create notebook</button>\n\t\t</div>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["notebooks/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="notebooks_index_container">\t\n\t<div class="notebooks_header">\n\t\t<div class="notebooks_header_text">\n\t\tNOTEBOOKS\n\t\t</div>\n\t\t<img class="add_notebook_img" src="assets/add-notebook.png" alt="">\n\t</div>\n\t<div class="notebook_items"></div>\n\n\t<div class="notebook_trash">\n\t\tTrash\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["notebooks/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="#/notebooks/',  notebook.escape('id') ,'">\n\t<div class="notebook_item_container">\n\t\t<div class="notebook_title_text">\n\t\t\t',  notebook.escape("title") ,'\n\t\t</div>\n\t\t<img class="notebook_trash_hover_img" src="assets/trash-visible.png" alt="">\n\t\t<div class="notebook_count_text">\n\t\t\t',  notebook.notes().length ,' Notes \n\t\t</div>\n\t<div>\n</a>\n\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["notebooks/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="notebook_show">\n\n\t<div class="notebook_header_content">\n\t\t<div class="notebook_show_title">\n\t\t\t',  notebook.escape("title") ,'\n\t\t</div>\n\t</div>\n\n\t<div class="notebook_list_item"></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["notes/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="note_show_container">\n\t<div class="note_header_icons">\n\t</div>\n\n\t<div class="note_form_container">\n\t\t<form class="note_form">\n\t\t    <select id="notebook_id" name="notebook_id">\n\t\t    ');  _(notebooks.models).each(function(notebook) { ; __p.push('\n\t\t      <option value="',  notebook.id ,'">\n\t\t        ',  notebook.escape("title") ,'\n\t\t      </option>\n\t\t    ');  }) ; __p.push('\n\t\t  </select>\n\t\t  <br>\n\t\t  <input type="text"\n\t\t         name="title"\n\t\t         class="note_title"\n\t\t         value="',  note.escape('title') ,'"\n\t\t         placeholder="Title your note">\n\t\t  <br>\n\t\t  <textarea class="note_content" name="content">',  note.escape("content") ,'</textarea>\n\t\t  <br>\n\t\t  <input class="submit_note" type="submit" value="Done">\n\t\t</form>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["notes/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="notes_container">\t\n\n\t<div class="header_container">\n\t\t\t<div class="header_text_notes">\n\t\t\t\tNOTES\n\t\t\t</div>\n\n\t\t\t<div class="notes_count_text">\n\t\t\t\t',  notes.size() ,' Notes\n\t\t\t</div>\n\t</div>\n\n\t\n\n\t<div class="notes_list"></ul>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["notes/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<a href="#/notes/',  note.get('id') ,'">\n\n\t<div class="notes_list_item">\n\n\t\t<div class="notes_list_content_container">\n\n\t\t\t<div class="time_ago">\n\t\t\t\tminutes ago\n\t\t\t</div>\n\n\t\t\t<img class="notebook_trash_hover_img" src="assets/trash-visible.png" alt="">\n\t\t\t\n\t\t\t<div class="notes_item_title">\n\t\t\t\t',  note.escape("title") ,'\n\t\t\t</div>\n\t\t\t\n\t\t\t<div class="notes_item_content">\n\t\t\t\t',  note.escape("content").slice(0, 220) ,'\n\t\t\t</div>\n\t\t</div>\n\n\t</div>\n</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["notes/main_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="note_show_container">\n\t<div class="note_header_icons">\n\t</div>\n\n\t<div class="note_form_container">\n\t\t<form class="note_form">\n\t\t    <select id="notebook_id" name="notebook_id">\n\t\t    ');  _(notebooks.models).each(function(notebook) { ; __p.push('\n\t\t      <option value="',  notebook.id ,'">\n\t\t        ',  notebook.escape("title") ,'\n\t\t      </option>\n\t\t    ');  }) ; __p.push('\n\t\t  </select>\n\t\t  <br>\n\t\t  <input type="text"\n\t\t         name="title"\n\t\t         class="note_title"\n\t\t         value="',  note.escape('title') ,'"\n\t\t         placeholder="Title your note">\n\t\t  <br>\n\t\t  <textarea class="note_content" name="content">',  note.escape("content") ,'</textarea>\n\t\t  <br>\n\t\t  <input class="submit_note" type="submit" value="Submit">\n\t\t</form>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["notes/modal"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="modal_container">\n\t<div class="modal" style="top: ',  dim.top ,'px; left: ',  dim.left ,'px;">\n\n\t\t<div class="trash_logo">\n\t\t\t<img src="assets/delete-trash.png" alt="">\n\t\t</div>\n\n\t\t<div class="modal_header">\n\t\tDelete Note/Notebook\n\t\t</div>\n\n\t\t<div class="modal_content">\n\t\tAre you sure you want to delete ',  model.title ,'\n\t\t</div>\n\n\t\t<div class="modal_buttons">\n\t\t\t<button class="cancel">Cancel</button>\n\t\t\t<button class="confirm">Confirm</button>\n\t\t</div>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["notes/search"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="search__body">\n\t<div class="search__input">\n\t\t<input id="search-query" type="text" placeholder="search notes">\n\t</div>\n\t<hr>\n\t<div class="search-results"></div>\n</div>\n');}return __p.join('');};
}).call(this);
